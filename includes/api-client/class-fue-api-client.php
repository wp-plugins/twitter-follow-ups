<?php
/**
 * Follow-Up Emails API Client Class
 *
...
class FUE_API_Client {

    /**
     * API base endpoint
     */
    const API_ENDPOINT = 'fue-api/v1/';
     ...
     * @param string  $wp_url          The URL to the WordPress site
     * @param boolean $is_ssl          If the URL is using SSL or not, optional
     * @throws Exception
     */
    public function __construct( $consumer_key, $consumer_secret, $wp_url, $is_ssl = false ) {
        if ( ! empty( $consumer_key ) && ! empty( $consumer_secret ) && ! empty( $wp_url ) ) {
            $this->_api_url = (  rtrim($wp_url,'/' ) . '/' ) . self::API_ENDPOINT;
    ...
    public function get_emails() {
        return $this->_make_api_call( 'emails' );
    }

    /**
     * Get a single follow-up email
     * @param  integer $email_id
     * @return mixed|json string
     */
    public function get_email( $email_id ) {
        return $this->_make_api_call( 'emails/' . $email_id );
    }
    ...
    public function create_email( $data ) {
        return $this->_make_api_call( 'emails', $data, 'POST' );
    }
    ...
    public function delete_email( $email_id ) {
        return $this->_make_api_call( 'emails/' . $email_id, $data = array(), 'DELETE' );
    }
     ...
     * @return mixed|json string
     */
    public function get_queue( $params = array() ) {
        return $this->_make_api_call( 'queue', $params );
    }
    ...
    public function get_queue_item( $item_id ) {
        return $this->_make_api_call( 'queue/' . $item_id );
    }
    ...
    public function create_queue_item( $data ) {
        return $this->_make_api_call( 'queue', $data, 'POST' );
    }
    ...
    public function update_queue_item( $item_id, $data ) {
        return $this->_make_api_call( 'queue/' . $item_id, $data, 'POST' );
    }
     ...
     * @return mixed|json
     */
    public function delete_queue_item( $item_id ) {
        return $this->_make_api_call( 'queue/' . $item_id, array(), 'DELETE' );
    }
    ...
    /**
     * Get link click reports
     * @param  array  $params
     * @return mixed|json string
     */
    public function get_link_click_report( $params = array() ) {
        return $this->_make_api_call( 'reports/emails/clicks', $params );
    }

    /**
     * Get email open reports
     * @param  array  $params
     * @return mixed|json string
     */
    public function get_email_open_report( $params = array() ) {
        return $this->_make_api_call( 'reports/emails/opens', $params );
    }
     ...
     * @return mixed|json string
     */
    public function get_ctor_report( $params = array() ) {
        return $this->_make_api_call( 'reports/emails/ctor', $params );
    }
    ...
    public function get_users_report( $params = array() ) {
        return $this->_make_api_call( 'reports/users', $params );
    }
     ...
     * @return mixed|json string
     */
    public function get_opt_outs_report( $params = array() ) {
        return $this->_make_api_call( 'reports/excludes', $params );
    }
